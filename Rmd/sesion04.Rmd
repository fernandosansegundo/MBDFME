...
+ Vamos a usar R para jugar a estos dos juegos sin tener que jugarnos el dinero. Descarga este \link{https://raw.githubusercontent.com/fernandosansegundo/MBDFME/master/scripts/sesion04-01-JuegosDeMere.R}{fichero de código} y ejecútalo. 
...
+ Vamos a usar este \link{https://raw.githubusercontent.com/fernandosansegundo/MBDFME/master/scripts/sesion04-TablasContingencia.R}{script de R} para aprender algo más de lenguaje sobre tablas de contingencia y de como manejarlas con R.
...
\normalsize Insistimos, la novedad es que *la suma de dos normales independientes sigue siendo normal*.  Ejecuta este código para ver un ejemplo\scriptsize
    ```{r echo = -1, fig.align='center', out.width = "30%"}
    ## Suma (y mezcla) de normales independientes.
    set.seed(2019)
...
- \link{https://raw.githubusercontent.com/fernandosansegundo/MBDFME/master/scripts/sesion04-comandos.R}{Código de esta sesión}
