...
<!-- # Regresión más allá del modelo simple.  -->

<!-- ## Regresión no lineal con una variable explicativa. -->

<!-- XKCD fitting curves -->

<!-- ## Regresión multivariable -->

<!-- *Caffo: one of the main uses of multivariate regression (is) to consider a relationship between a predictor and response, while accounting for other variables.* -->

<!-- ## Expresión de los coeficientes estimados en términos de residuos. -->

<!-- ## Interpretación de los coeficientes. -->

<!-- the interpretation of a multivariate regression coefficient is the expected change in the response per unit change in the regressor, holding all of the other regressors fixed *(adjusting for the other regressors)*. -->
