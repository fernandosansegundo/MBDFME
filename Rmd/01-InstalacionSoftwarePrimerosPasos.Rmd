...
+ Este diagrama creado por \link{http://drewconway.com/zia/2013/3/26/the-data-science-venn-diagram}{Drew Conway} es uno de los más usados para describir el Análisis de Datos. 
  ```{r echo=FALSE, comment=NULL, fig.align='center', out.width = "50%"}
...
```{r echo=FALSE, eval= FALSE, comment=NULL, fig.align='center', out.width = "80%"}
...
<!-- library("eurostat") -->
<!-- library("dplyr") -->
<!-- query = search_eurostat("fertility", type = "table") -->
<!-- View(query) -->
...
<!-- mapdata <- merge(fertility, resolution = "20") -->
...
+ La librería `gapminder` que hemos instalado antes contiene una tabla de datos con algunas características socioeconómicas de casi todos los paises del mundo a lo largo de varios lustros (proceden de [\textcolor{blue}{{www.gapminder.org}}](https://www.gapminder.org)). Carga la tabla y examínala con
  ```{r eval=FALSE}
  library(gapminder)
  View(gapminder)
  ```
