...
- Como lector de documentos pdf puedes usar \link{https://get.adobe.com/es/reader/}{Adobe Reader}, aunque en Windows te recomendamos \link{{Sumatra Pdf}https://www.sumatrapdfreader.org/free-pdf-reader.html} y en Mac recomendamos *Vista Previa* p \link{https://skim-app.sourceforge.io/}{Skim}.
...
+ El material de las sesiones del curso está alojado en un \link{https://github.com/fernandosansegundo/MBDFME}{repositorio en GitHub}. Si conoces Git ya sabrás que puedes usarlo para hacer un fork o clonar ese repositorio. Desde luego también puedes descargar el contenido íntegro del repositorio como fichero zip. Y la página de la asignatura en Moodle contiene enlaces a los ficheros de ese repositorio. Pero si no estás familiarizado con Git quizá sea una buena idea usar esta asignatura para empezar a conocer una herramienta tan importante. 

+ Puedes empezar por los vídeos 14 y 15 de esta \link{https://www.youtube.com/watch?v=3hqGcRoEYUY&list=PLmTpraKlPXDSPbP2L8MYZoweGSzi9gNTr}{playlist} del curso Data Science Toolbox de la Universidad John Hopkins para Coursera. También puedes encontrar información en este \link{https://lab.github.com/githubtraining/introduction-to-github}{curso de Introducción a GitHub}. Pregunta a tu profesor si necesitas más ayuda para empezar.  
...
+ Si usas Mac o Linux ya tienes una instalación de Python en tu sistema. En Windows tienes que instalar una distribución de Python antes de usarla. **ATENCIÓN:** la instalación de Python es una fuente habitual de quebraderos de cabeza. Si dudas es *mucho mejor* que preguntes a tus profesores y te informes bien antes de hacer cambios que pueden dañar tu sistema gravemente. 
...
+ El uso de Docker para la asignatura es *muy experimental* en este curso. Si tienes interés en probarlo habla con tu profesor. Pero desaconsejamos firmemente usarlo en este momento como herramienta principal para el trabajo en la asignatura.  
...
- Junto con los vectores, las tablas y listas constituyen las estructuras de datos básicos de R. Vamos a ver ahora el segundo de estos tipos de estructuras.
...
- Si quieres ver la tabla completa usa `View(iris)`.  La tabla se abrirá en otra pestaña del editor de RStudio.
